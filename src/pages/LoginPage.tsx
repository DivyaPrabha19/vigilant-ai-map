  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-background">
      ...
      >
        ...
        >
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-2xl gradient-neon mb-4 neon-glow-cyan">
            <Shield className="w-10 h-10 text-primary-foreground" />
          </div>
          <h1 className="text-3xl font-bold font-display gradient-neon-text">AI GUARDIAN</h1>
          <p className="text-muted-foreground mt-2 text-sm">Your AI-Powered Safety Companion</p>
        </motion.div>
            ...
            >
              {!isLogin && (
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 rounded-xl bg-muted/50 border border-border text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all"
                  />
                </div>
              )}
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-12 py-3 rounded-xl bg-muted/50 border border-border text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all"
                />
                <button
                  type="button"
